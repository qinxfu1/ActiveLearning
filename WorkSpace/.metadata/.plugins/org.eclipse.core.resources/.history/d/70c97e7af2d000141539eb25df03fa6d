...
public class CenterInstances implements iPickInstances{
	...
	public ArrayList<InstanceProxy> getInstances(Cluster A, double instancesPercentage) {
		...
		for(InstanceProxy ins:A.getInstances())
		{
			...
			instances.add(new InternalCentriodDistance(disToACentroid, ins));	
		}
